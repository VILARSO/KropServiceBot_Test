...
WELCOME_MESSAGE = (
    "👋 Вітаємо\\ у KropServiceBot\\!\n\n"
    "Це сервіс для розміщення та пошуку оголошень про послуги, роботу і підробітки у Кропивницькому\\.\n\n"
    "🛠️ Створіть оголошення або знайдіть виконавця прямо зараз\\.\n\n"
    "➕ — Додати оголошення\n"
    "🔍 — Пошук оголошень\n"
    "🗂️ — Мої оголошення\n"
    "❓ — Допомога\n\n"
